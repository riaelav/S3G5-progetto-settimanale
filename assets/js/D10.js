...
console.log("Numero random:", dice());
/* ESERCIZIO 2
...
console.log("Maggiore tra due numeri", whoIsBigger(2, 8));
...
console.log(deleteOne("HOLA", true));
...
console.log(isThisAnEmail("valep@gmailcom"));
...
console.log("Oggì è:", whatDayIsIt());
...
function isTodayMyBirthday() {
  ...
  const myBirthday = new Date(today.getFullYear(), 11, 11);

  if (today.getDate() === myBirthday.getDate() && today.getMonth() === myBirthday.getMonth() && today.getFullYear() === myBirthday.getFullYear()) {
    return true;
  } else {
    return false;
  }
}
console.log("Is it my birthday?", isTodayMyBirthday());
...
const anotherMe = { name: "Valeria", age: "29" };
console.log(anotherMe);
console.log(deleteProp(anotherMe, "age"));
...
console.log("Newest movie title:", newestMovie(movies));
...
console.log("Movies number:", countMovies(movies));
...
console.log("Somma degli anni dei film:", sumAllTheYears(movies));
...
/* ESERCIZIO 19
  Scrivi una funzione chiamata "removeIndex" che riceve un numero come parametro e ritorna l'array "movies" fornito privo dell'elemento nella 
